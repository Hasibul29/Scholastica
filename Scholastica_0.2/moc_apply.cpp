...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_apply_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_apply_t qt_meta_stringdata_apply = {
    {
QT_MOC_LITERAL(0, 0, 5), // "apply"
QT_MOC_LITERAL(1, 6, 27), // "on_pushButton_apply_clicked"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 14) // "on_bbn_clicked"

    },
    "apply\0on_pushButton_apply_clicked\0\0"
    "on_bbn_clicked"
};
...
QT_INIT_METAOBJECT const QMetaObject apply::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_apply.data,
    qt_meta_data_apply,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *apply::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_apply.stringdata0))
